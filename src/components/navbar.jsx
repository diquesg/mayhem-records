                ...
                <ul className="bg-[#141414] shadow-lg shadow-neutral-950 grid grid-cols-5 items-center m-2 border min-h-19 rounded-xl text-[12px] lg:hidden">
                    <li className="m-auto">
                        <button className="justify-items-center">
                            <Link href="/" className="flex flex-col items-center gap-1 active:scale-90 transition-all">
                    ...
                    <li className="m-auto">
                        ...
                        >
                            <div className="flex flex-col items-center gap-1 active:scale-90 transition-all">
                    ...
                    <li className="m-auto">
                        <button className="justify-items-center">
                            <Link href="/catalogo" className="flex flex-col items-center gap-1 active:scale-90 transition-all">
                    ...
                    <li className="m-auto">
                        <button className="justify-items-center relative">
                            <Link href="/carrinho" className="flex flex-col items-center gap-1  active:scale-90 transition-all">
                    ...
                    <li className="m-auto">
                        <button className="justify-items-center">
                            <Link href="/conta" className="flex flex-col items-center gap-1  active:scale-90 transition-all">
