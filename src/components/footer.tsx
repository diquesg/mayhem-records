...
export default function Footer(){
    return(
        <footer className="md:px-30 lg:px-12 md:mb-20 lg:mb-0 xl:px-60 md:gap-6 lg:gap-0 px-60 bg-[url(/footer-bg.png)] bg-top bg-cover py-9 text-neutral-400 justify-between border-t border-neutral-700 hidden md:flex md:flex-col lg:flex-row">
            <div className="flex flex-col gap-4">
                <Image src="/logo2.svg" alt="logo" height={32} width={247}/>
