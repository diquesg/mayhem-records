...
export default function CartPage() {
  ...
  return (
    <>
    <div className="mt-16 md:mt-50 m-3 pb-60 md:pb-20 2xl:mx-60">
      <h1 className='flex gap-2 text-xl items-center justify-center font-bold p-3 mb-1 fixed top-0 z-20 mt-1 w-full md:hidden'><ShoppingCart strokeWidth={2} width={28} height={28}/>Carrinho</h1>
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2">
          <div className="flex flex-col gap-3 mt-3 bg-[#101010] border rounded-lg p-8">
            <h1 className='flex gap-2 text-xl items-center justify-start font-medium text-white mb-5 w-full'><ShoppingCart strokeWidth={2} width={28} height={28}/>CARRINHO</h1>
            {cartItems.map((item) => (
                ...
                <div className='flex'>
                    ...
                    <div className="ml-3 flex-grow flex flex-col">
                        <div className='flex items-baseline justify-start gap-3'>
                            ...
                            {item.edition === "Deluxe" && <div className='absolute bg-amber-400 rounded p-1 top-2 left-2 md:static md:w-fit'>
                            ...
                            {item.edition === "Exclusive" && <div className='absolute bg-purple-500 rounded p-1 top-0 left-0 border-black md:static md:w-fit'>
        ...
        <div>
          <div className="bg-[#131313] md:bg-[#101010] rounded-lg p-5 border-t md:p-8 md:border md:border-neutral-800 md:mt-3  border-neutral-600 fixed z-10 w-full left-0 bottom-20 rounded-b-none lg:static lg:rounded-md">
            ...
            <div className='flex items-center justify-between md:flex-col md:items-start md:gap-4'>
              ...
              <Link href="/carrinho/pagamento" className='md:w-full'><button className='bg-white active:scale-90 hover:bg-neutral-400 hover:scale-104 transition-all md:max-h-12 md:border-2 md:border-[#A5A1A1] active:bg-neutral-400 px-3 md text-black p-3 md:p-2 rounded-full md:rounded-md w-fit md:w-full flex justify-center gap-1 items-center font-bold text-lg'><CreditCard/>Pagamento</button></Link>
            </div>
            <div className='mt-12'>
