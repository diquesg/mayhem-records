  ...
  return (
    <div className="mt-16 m-3 pb-60">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col gap-3 mt-3">
            {cartItems.map((item) => (
                <div key={item._id} className="border-b p-3 relative bg-[#171717] border border-neutral-700 shadow-lg shadow-black rounded-md">
                  {item.edition === "Deluxe" && <div className='absolute bg-amber-400 rounded p-1 top-0 left-0 m-5'>
                  ...
                  {item.edition === "Exclusive" && <div className='absolute bg-purple-500 rounded p-1 top-0 left-0 m-5 border-black'>
                ...
                <div className='flex'>
                    ...
                    <div className="ml-3 flex-grow flex flex-col">
                        <div className='flex items-baseline justify-between'>
                            <Link href={`/catalogo/${item._id}`} className="font-medium my-auto max-w-47 hover:underline active:underline underline-offset-2"><h3>{item.title}</h3></Link>
        ...
        <div>
          <div className="bg-[#131313] rounded-lg p-5 border-t border-neutral-600 fixed z-10 w-full left-0 bottom-20 rounded-b-none lg:static lg:rounded-md">
