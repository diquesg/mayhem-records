    ...
    <html lang="pt-br" className={interFont.className} suppressHydrationWarning>
      <body>
        <ThemeProvider attribute="class" defaultTheme="system" enableSystem disableTransitionOnChange>
          <header className={`${libreFont.className} flex items-center justify-center gap-2 h-16 border-b-1 border-b-neutral-700 fixed w-full top-0 z-10`} style={{ backgroundColor: '#0D0D0D' }}>
